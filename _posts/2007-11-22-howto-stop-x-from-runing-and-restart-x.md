...
بعض الأحيان تريد وقف عمل الـ X أو الـ X Window أو الـ X Server كلها تشير الى النظام الخاصة بالواجهة الرسومية في لينوكس … لوقف عملها ممكن تقوم بتغيير الــ [Run Level](/assets/files/2007/asset.bin.bin) الى مستوى ﻻ يعمل فيه الــ X كما في الــ Run Level 3 … يتم ذلك بهذه الطريقة:
