...
categories: ["AntiX", "ThreatHunting", "Windows"]
...
What does all that mean here? Well, continuing the previous work “[Creating a Hidden Prefetch File to Bypass Normal Forensic Analysis](/assets/files/2019/creating-a-hidden-prefetch-file-to-bypass-normal-forensic-analysis)” it means we just got a fix or a new feature added to PECmd :)
