...
categories: ["Networks", "Privacy", "Security"]
tags: ["Anonymity", "FTP", "HTTP Headers", "SFTP", "ssh", "Telnet", "Tor", "User-Agent", "usewithtor", "wget"]
...
```
$ usewithtor wget www.binary-zone.com/somefile.iso -U "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 2.0.50727)"
```
