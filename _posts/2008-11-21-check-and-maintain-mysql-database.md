...
**ملاحظة:** قبل أن تقوم بتطبيق أي من الكلام الموجود في هذه الصفحة، قم بأخذ [نسخة إحتياطية من قاعدة البيانات](/assets/files/2008/howto-make-a-backup-of-a-mysql-database.bin.bin) التي لديك …
...
الآن لعمل فحص على جداول القواعد من نوع MyISAM أو ISAM نقوم [بإيقاف خدمة MySQL](/assets/files/2008/howto-start-mysql-server.bin.bin) من خلال الأمر:
