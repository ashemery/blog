...
categories: ["Apache/Tomcat", "GNU/Linux", "Patch Management"]
tags: ["CentOS", "Dependency", "jpackage", "jpackage-utils", "Missing", "rebuild-security-providers", "Redhat", "Tomcat", "yum"]
...
إن كان لديك سؤال أو إستفسار؟ ضعه [هنا](http://www.linuxac.org/forum/linuxac32/thread34442.html) …
