...
أكيد قرأت الموضوع السابق بعنوان [Disabling Weak SSLv2 Support in Apache Server](/assets/files/2009/disabling-weak-sslv2-support-in-apache-server) والآن تتسائل كيف تقوم بالتحقق من عملك تم بنجاح أم لا … أو كيف تتحقق من نسخة البروتوكول والمشفرات التي على دومين معيين؟ جواب هذا السؤال هو هذا الموضوع إن شاء الله …
